        ...
        for(var i = 0; i < number; i++) {
            factory.tokens(i, function(error, address) {
                ...
                property.propertyDetails(function(error, details) {
					...
					var totalSupply = parsedData[2].c[0]
					var tokensBought = parsedData[3].c[0]
					var tokensLeft = parsedData[4].c[0]
					...
					// var parsedData = String(JSON.stringify(details)).split(',')
					// var parsedData = JSON.stringify(details)
                    // console.log(address + ', ' + name + ', ' + symbol + ', ' + totalSupply + ', ' + tokensBought + ', ' + tokensLeft)
                })
            })
        }
    })
